::  by JaCk  |  Release 01/21/2018  |  https://github.com/1ijack/BatchMajeek/blob/master/elevate/elvn.cmd  |  elvn.cmd  --  checks current env to see if we're already elevated, when not we relaunch elevated. Minized method.
:::
...
call :func_jack_me_sudo_via_net_session || ( endlocal & goto :eof )
